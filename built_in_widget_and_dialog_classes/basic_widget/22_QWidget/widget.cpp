...
void Widget::mousePressEvent(QMouseEvent *event)
{
    ...
    qDebug("[Mouse Press] x, y : %d , %d ", event->pos().x(), event->pos().y());
}

void Widget::mouseReleaseEvent(QMouseEvent *event)
{
    Q_UNUSED(event);
    qDebug("[Mouse Release] x, y : %d , %d ", event->pos().x(), event->pos().y());
}

void Widget::mouseDoubleClickEvent(QMouseEvent *event)
{
    Q_UNUSED(event);
    qDebug("[Mouse Double Click] x, y : %d , %d ", event->pos().x(), event->pos().y());
}

void Widget::mouseMoveEvent(QMouseEvent *event)
{
    Q_UNUSED(event);
    qDebug("[Mouse Move] x, y : %d , %d ", event->pos().x(), event->pos().y());
}
